 ...
 * @param {(actor: Actor, skill: string, dc: number) => Promise<boolean|null>} roll Roll a skill check.
 ...
 * @returns {((actor: Actor, skill: string, dc: number) => Promise<boolean|null>)|undefined}
 */
