/** @type {Map<string, (actor: Actor, formula: string, options: {damageType: string|null, postCard: boolean, rollMode: string|null}) => Promise<void>>} */
 ...
 * @param {(actor: Actor, formula: string, options: {damageType: string|null, postCard: boolean, rollMode: string|null}) => Promise<void>} apply Roll and apply the damage/healing.
 ...
 * @returns {((actor: Actor, formula: string, options: {damageType: string|null, postCard: boolean, rollMode: string|null}) => Promise<void>)|undefined}
 */
